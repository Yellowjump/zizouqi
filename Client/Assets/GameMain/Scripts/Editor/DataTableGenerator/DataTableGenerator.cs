...
namespace DataTable.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        private const string DataTablePath = "Assets/GameMain/Data/DataTables";
        private const string CSharpCodePath = "Assets/GameMain/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/GameMain/Scripts/DataTable/DataTableCodeTemplate.txt";
