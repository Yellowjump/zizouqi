...
public class SkillSystemEditorWindow : EditorWindow
{
    ...
    readonly string buffTemplatePath = Application.dataPath + @"/GameMain/Data/BuffTemplate";
    readonly string buffTemplateTableFilePath = Application.dataPath + @"/GameMain/Data/DataTables/BuffTemplate.txt";
    //-------buff模板end
    ...
    readonly string skillTemplatePath = Application.dataPath + @"/GameMain/Data/SkillTemplate";
    readonly string skillTemplateTableFilePath = Application.dataPath + @"/GameMain/Data/DataTables/SkillTemplate.txt";
    //-------技能模板end
