	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult738 = clamp( ( (0.5 + (input.ase_texcoord9.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , -1.0 , 1.0 );
...
ASEEND*/
//CHKSM=6A39942429CCFAE7AAD5C3D27B757CF93AB8C4CB