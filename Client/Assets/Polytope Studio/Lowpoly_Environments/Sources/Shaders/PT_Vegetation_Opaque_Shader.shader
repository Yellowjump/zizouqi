	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult555 = clamp( ( (0.5 + (input.ase_texcoord9.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , 0.0 , 1.0 );
				...
				float2 texCoord578 = input.ase_texcoord8.xy * float2( 1,1 ) + temp_cast_2;
				float clampResult596 = clamp( step( texCoord578.x , 1.0 ) , 0.0 , 1.0 );
				float2 temp_cast_3 = (0.0).xx;
				float2 texCoord577 = input.ase_texcoord8.xy * float2( 1,1 ) + temp_cast_3;
...
ASEEND*/
//CHKSM=943BFC774C902413A785DE7DE4758F6DB608837C