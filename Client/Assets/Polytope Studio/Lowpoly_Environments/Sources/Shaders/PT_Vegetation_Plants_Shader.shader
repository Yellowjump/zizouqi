	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord743 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord527 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=F703CCF17B2F77EF93CDCCC45D362E6B8D608BFF